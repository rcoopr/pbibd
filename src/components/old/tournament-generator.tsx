        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          {/* <div>
            ...
            <input
              ...
              style={{ zoom: 1.5 }}
              className="mt-1 cursor-pointer block rounded-md border-gray-300 shadow-xs focus:border-indigo-300 focus:ring-3 focus:ring-indigo-200 focus:ring-opacity-50"
            />
          </div> */}
        </div>
